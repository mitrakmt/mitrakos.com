...
export const article = {
  ...
  description:
    'Why Tailwind CSS is a powerful utility-first framework for modern web design — its benefits, setup process, and practical examples for your workflow.',
}

export const metadata = {
  // Shorter than the on-page H1 (`article.title`) so it survives Google's
  // ~60-character title truncation. The full title still renders on the page,
  // in the article cards, and in the social previews below.
